...
namespace Coorth.Maths {
    public static partial class VectorUtil {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 YZ(this in Vector3 v) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float LengthXY(this in Vector3 v) {
            return (float) Math.Sqrt(v.X * v.X + v.Y * v.Y);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float LengthYZ(this in Vector3 v) {
            return (float) Math.Sqrt(v.Y * v.Y + v.Z * v.Z);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector3 Normalize(this in Vector3 v) {
            return v.LengthSquared() > MathUtil.ZERO_TOLERANCE ? Vector3.Normalize(v) : Vector3.Zero;
        }
