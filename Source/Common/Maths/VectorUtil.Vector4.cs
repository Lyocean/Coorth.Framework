...
namespace Coorth.Maths {
    public static partial class VectorUtil {
        ...
        public static Vector2 XY(this in Vector4 v) {
            return new Vector2(v.X, v.Y);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 XZ(this in Vector4 v) {
            return new Vector2(v.X, v.Z);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 YZ(this in Vector4 v) {
            return new Vector2(v.Y, v.Z);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector3 XYZ(this in Vector4 v) {
            return new Vector3(v.X, v.Y, v.Z);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float LengthXZ(this in Vector4 v) {
            return (float) Math.Sqrt(v.X * v.X + v.Z * v.Z);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float LengthXY(this in Vector4 v) {
            return (float) Math.Sqrt(v.X * v.X + v.Y * v.Y);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float LengthYZ(this in Vector4 v) {
            return (float) Math.Sqrt(v.Y * v.Y + v.Z * v.Z);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4 Normalize(this in Vector4 v) {
            return v.LengthSquared() > MathUtil.ZERO_TOLERANCE ? Vector4.Normalize(v) : Vector4.Zero;
        }
