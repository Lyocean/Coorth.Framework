...
[Serializable, Serializer(typeof(bool))]
...
[Serializable, Serializer(typeof(byte))]
...
[Serializable, Serializer(typeof(sbyte))]
...
[Serializable, Serializer(typeof(short))]
...
[Serializable, Serializer(typeof(ushort))]
...
[Serializable, Serializer(typeof(int))]
...
[Serializable, Serializer(typeof(uint))]
...
[Serializable, Serializer(typeof(long))]
...
[Serializable, Serializer(typeof(ulong))]
...
[Serializable, Serializer(typeof(Half))]
...
[Serializable, Serializer(typeof(float))]
...
[Serializable, Serializer(typeof(double))]
...
[Serializable, Serializer(typeof(decimal))]
...
[Serializable, Serializer(typeof(char))]
...
[Serializable, Serializer(typeof(string))]
...
[Serializable, Serializer(typeof(DateTime))]
...
[Serializable, Serializer(typeof(TimeSpan))]
...
[Serializable, Serializer(typeof(Type))]
...
[Serializable, Serializer(typeof(Guid))]
