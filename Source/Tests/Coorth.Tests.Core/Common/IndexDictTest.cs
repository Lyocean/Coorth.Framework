...
namespace Coorth.Tests.Common {
    internal class IndexDictTest {
        ...
        [Test]
        public void Add_With_Key_Hash_Conflict() {
            var dict = new IndexDict<int>(4);
            dict.Add(1, 2);
            dict.Add(5, 4);
        ...
        [Test]
        public void Add_With_MulitKey_Hash_Conflict() {
            var dict = new IndexDict<int>(4);
            dict.Add(1, 2);
            dict.Add(5, 4);
            dict.Add(9, 5);
        ...
        [Test]
        public void Add_Key_Duplicate_Exception() {
            var dict = new IndexDict<int>(4);
            dict.Add(1, 2);
