...
namespace Coorth {
    ...
    public readonly struct EventGraphEnter : IEvent {
        public static EventGraphEnter Instance;
    }
    
    public readonly struct EventGraphExit : IEvent {
        public static EventGraphExit Instance;
    }
    ...
    public readonly struct EventNodeExit : IEvent {
        public static EventNodeExit Instance;
