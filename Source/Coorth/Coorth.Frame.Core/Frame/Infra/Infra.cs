...
namespace Coorth {
    public class Infra : IServiceFactory {
        ...
        public static ServiceBinding<T> Bind<T>(Func<ServiceContainer, T> provider) where T : class  => services.Bind<T>(provider);
        ...
        public ServiceBinding<T> BindService<T>(Func<ServiceContainer, T> provider) where T : class  => Bind<T>(provider);
